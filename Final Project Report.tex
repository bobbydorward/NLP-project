...
\begin{figure}
\tre{put the bad summary example here, reference it by using $\backslash$ref\{badsummary\}}
\caption{\tre{put the caption here}}\label{badsummary}
\end{figure}
\begin{figure}
\tre{put the good summary example here, reference it by using $\backslash$ref\{goodsummary\}}
\caption{\tre{put the caption here}}\label{goodsummary}
\end{figure}
...
\section{Results}
	...
	Here we have an example of a summary generated by our final program: 
	\begin{center}
