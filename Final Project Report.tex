...
The results of this first attempt at pruning can be seen in Figure~\ref{badsummary}. As we can see, the pruning is too aggressive, pruning sentences down to their keywords, but creating giberish in the process. 
